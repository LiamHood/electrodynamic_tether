...
% https://ccmc.gsfc.nasa.gov/modelweb/models/iri2012_vitmo.php (hence
...
% Data starts at line 239. If there isn't a line 239, there was an error.
...
data = sscanf(result(newlines(238)+1 : newlines(238 + sweeplen)-1), '%f');