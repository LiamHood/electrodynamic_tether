...
%   [9] D. Bilitza, R. Eyfrig, and N. M. Sheikh, "A global model for the
%   height of the F2-peak using M3000 values from the CCIR numerical map,"
%   _Telecomm._J._, vol. 46, pp. 549-553, 1979.
%   [10] D. Altadill, S. Magdaleno, J. M. Torta, and E. Blanch, "Global
%   empirical models of the density peak height and of the equivalent scale
%   height for quiet conditions," _Adv._Space_Res._, vol. 52, no. 10, pp.
%   1756-1769, 2013, doi:10.1016/j.asr.2012.11.018.
%   [11] V. N. Shubin, "Global median model of the F2-layer peak height
%   based on ionospheric radio-occultation and ground-based Digisonde
%   observations," _Adv._Space_Res._, vol. 56, no. 5, pp. 916-928, 2015,
%   doi:10.1016/j.asr.2015.05.029.
%   [12] D. Bilitza, S. M. Radicella, B. W. Reinisch, J. O. Adeniyi, M. E.
%   Mosert Gonzalez, S. R. Zhang, and O. Obrou, "New B0 and B1 models for
%   IRI," _Adv._Space_Res._, vol. 25, no. 1, pp. 89-95, 2000,
%   doi:10.1016/S0273-1177(99)00902-3.
%   [13] T. L. Gulyaeva, "Progress in ionospheric informatics based on
%   electron-density profile analysis of ionograms," _Adv._Space_Res._,
%   vol. 7, no. 6, 1987, doi:10.1016/0273-1177(87)90269-9.
%   [14] D. Altadilla, J. M. Tortaa, and E. Blanch, "Proposal of new models
...
%   [23] V. Truhlík, D. Bilitza, and L. T?ísková, "A new global empirical
...
%   [27] L. T?ísková, V. Truhlík, J. Šmilauer, "An empirical model of
